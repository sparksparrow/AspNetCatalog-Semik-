        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeWord = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sizes_ProductItems_ProductItemId",
                        column: x => x.ProductItemId,
                        principalTable: "ProductItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "PageTitles",
                columns: new[] { "Id", "CodeWord", "MetaDescription", "MetaKeywords", "Title" },
                values: new object[,]
                {
                    { new Guid("94b842cd-7976-4dfb-b071-7a5cbab4617a"), "PageIndex", null, null, "Главная" },
                    { new Guid("8773f462-a492-4654-8945-b97204271824"), "PageCatalog", null, null, "Каталог" },
                    { new Guid("6fd4e3f7-f892-407b-ac03-e4354f834dc0"), "PageContacts", null, null, "Контакты" },
                    { new Guid("ea285ed5-1f80-4cbe-91d7-4d07e0a861b8"), "PageAbout", null, null, "О нас" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "96ba8f64-053a-4574-a0bb-b73ecc88c761", "4c6e757b-ecb2-40a8-94fe-a2d3ecca28ca" });
